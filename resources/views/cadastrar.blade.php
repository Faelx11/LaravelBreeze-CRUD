                ...
                <div class="p-10 text-gray-900">
                    ...
                    <form class="w-full max-w-lg" action="{{url('/store')}}" method="POST">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-2">
                            ...
                            <select class="text-center appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-estado" type="select" name="estado" maxlength="2">
